# Archive the application source folder as tar.gz for the ACR build context
...
# time_static/time_offset avoid perpetual diffs that timestamp() would
# cause on every plan - the SAS validity window is fixed once, at creation.
